...
export default () => {
  ...
  const masterItems = useSelector((state) => state.reducerMasterItem.data);
  ...
  const [configTable] = React.useState({
    ...
    tbColumns: [
      {
        title: t("master_item_code"),
        field: "code",
        width: 50,
      },
      {
        title: t("master_item_name_thai"),
        field: "name_thai",
        width: 250,
      },
      {
        title: t("master_item_name_eng"),
        field: "name_eng",
        width: 250,
      },
      {
        title: t("master_item_group_name"),
        field: "group_name",
        width: 250,
      },
      {
        title: t("master_item_category_name"),
        field: "category_name",
        width: 250,
      },
      {
        title: t("master_item_warehouse_code"),
  ...
  function asyncData() {
    (async () => {
      await globalHandleService.GlobalRequest(dispatch, TYPE_MASTER_ITEM);
    })();
  }
