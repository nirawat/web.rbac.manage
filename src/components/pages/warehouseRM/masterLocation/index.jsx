...
export default () => {
  ...
  const masterItems = useSelector((state) => state.reducerMasterLocation.data);
  ...
  const [configTable] = React.useState({
    ...
    tbColumns: [
      {
        title: t("master_location_code"),
        field: "code",
        width: 50,
      },
      {
        title: t("master_location_name_thai"),
        field: "name_thai",
        width: 250,
      },
      {
        title: t("master_location_name_eng"),
        field: "name_eng",
        width: 250,
      },
      {
        title: t("master_location_wh_name"),
  ...
  function asyncData() {
    (async () => {
      await globalHandleService.GlobalRequest(dispatch, TYPE_MASTER_LOCATION);
    })();
  }
