...
export default () => {
  ...
  const masterItems = useSelector((state) => state.reducerMasterGroup.data);
  ...
  const [configTable] = React.useState({
    ...
    tbColumns: [
      {
        title: t("master_group_code"),
        field: "code",
        width: 50,
      },
      {
        title: t("master_group_name_thai"),
        field: "name_thai",
        width: 250,
      },
      {
        title: t("master_group_name_eng"),
        field: "name_eng",
        width: 250,
      },
      {
        title: t("master_group_category_name"),
        field: "category_name",
        width: 200,
      },
    ],
