...
export default () => {
  ...
  const masterItems = useSelector((state) => state.reducerMasterCategory.data);
  ...
  const [configTable] = React.useState({
    ...
    tbColumns: [
      {
        title: t("master_category_code"),
        field: "code",
        width: 50,
      },
      {
        title: t("master_category_name_thai"),
        field: "name_thai",
        width: 250,
      },
      {
        title: t("master_category_name_eng"),
        field: "name_eng",
        width: 250,
      },
      {
        title: t("master_category_wh_name"),
