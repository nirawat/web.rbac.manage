...
export default () => {
  ...
  const masterItems = useSelector((state) => state.reducerSection.data);
  ...
  const [configTable] = React.useState({
    ...
    tbColumns: [
      {
        title: t("master_section_code"),
        field: "code",
        width: 50,
      },
      {
        title: t("master_section_name_thai"),
        field: "name_thai",
        width: 250,
      },
      {
        title: t("master_section_name_eng"),
        field: "name_eng",
        width: 250,
      },
    ],
