...
import ManageUnit from "./manage.unit";
...
export default () => {
  ...
  const masterItems = useSelector((state) => state.reducerMasterUnit.data);
  ...
  const [configTable] = React.useState({
    ...
    tbColumns: [
      {
        title: t("master_unit_code"),
        field: "code",
        width: 50,
      },
      {
        title: t("master_unit_name_thai"),
        field: "name_thai",
        width: 250,
      },
      {
        title: t("master_unit_name_eng"),
        field: "name_eng",
        width: 250,
      },
    ],
